declare module '@qsi/watermelondb/Database' {
  import { AppSchema, CollectionMap, DatabaseAdapter, Model, TableName } from '@qsi/watermelondb'
  import { CollectionChange } from '@qsi/watermelondb/Collection'
